  ...
  window.BzFS = (function () {
    var root = {
      ...
      children: {
        ...
        "about.txt": {
          type: "file", date: "Sep 24, 2026 1:04 AM", size: "1374 bytes",
          html: 'Bohdan Zhuravel\nSoftware Engineer at <a href="https://www.talkable.com" target="_blank" rel="noopener">Talkable</a>\n\nHi, I\'m Bohdan. Thanks for opening a text file, hardly anyone does.\n\nI write whatever the job needs, in whatever language fits it. With\nAI, anything is possible; knowing which tool to reach for is the part\nthat\'s still mine.\n\nI love old things and new things alike. The collection: two Apple\nExtended Keyboard IIs, four Keychrons, a Magic Keyboard, four\ntrackballs and one vertical mouse. My terminal: a small team of AI\nagents. I keep trying things, because the pursuit of excellence\ndeserves no explanation.\n\nI also own a PS4 and a PS5, a Switch and a Switch 2, an Xbox Series X\nand a few retro consoles. Life and work have been busy lately, so most\nof my gaming happens on YouTube, watching other people play.\n\nI love corgis, and I\'m human to Alf, the sweetest boi ever.\n\nI collect good tools, go looking for hard problems, and genuinely\nenjoy the work. I still run the Mac OS X Tiger "Aqua Blue" wallpaper,\nand I think a keyboard should sound like a keyboard.\n\nThis desktop is my idea of a homepage. Poke around, open things, drag\nsomething to the Trash (it\'s fine, nothing here is permanent).\n\nTry this: open Terminal and type `man bohdan`.\n\n  github    <a href="https://github.com/zhuravel" target="_blank" rel="me noopener">https://github.com/zhuravel</a>\n  linkedin  <a href="https://www.linkedin.com/in/bohdanzhuravel/" target="_blank" rel="noopener">https://www.linkedin.com/in/bohdanzhuravel/</a>\n  gaming    <a href="https://www.exophase.com/user/zhuravel/" target="_blank" rel="me noopener">https://www.exophase.com/user/zhuravel/</a>\n  email     run `finger bohdan`'
        },
        links: {
          type: "dir", date: "Sep 21, 2026 4:10 PM",
          children: {
